...
namespace Caching
{
    ...
    public static class IMethodInvocationExtensions
    {
        ...
        {
            return ToTraceString(invocation,  null, true, ": ", ", ");
        }
        ...
        /// <returns></returns>
        public static string ToTraceString(this IMethodInvocation invocation, string prefix = null)
        {
            return ToTraceString(invocation,  prefix, false, "", "_");
        }
        ...
        /// <returns></returns>
        public static string ToTraceString(this IMethodInvocation invocation, string prefix, 
        ...
        {            
            ...
            BuildArgumentsString(callBuilder, invocation,  includeParameterNames, separator, valueSeparator);
        ...
        private static void BuildArgumentsString(StringBuilder callBuilder, IMethodInvocation input, bool includeParameterNames, 
